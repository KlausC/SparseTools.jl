...
if stats_spqr_basic.flag == 0 && stats_spqr_null.flag == 0  && stats_spqr_basic.rank ~= stats_spqr_null.rank
...
if get_details == 1
    stats.est_err_bound_norm_A_times_N = stats_spqr_null.est_err_bound_norm_A_times_N
end
if nargout == 4
    stats.est_norm_A_transpose_times_NT = stats_spqr_basic.est_norm_A_transpose_times_NT
    if get_details == 1
        stats.est_err_bound_norm_A_transpose_times_NT = stats_spqr_basic.est_err_bound_norm_A_transpose_times_NT
    end
end

if get_details == 1
    stats.time_svd = stats_spqr_basic.time_svd + stats_spqr_basic.stats_ssi.time_svd + stats_spqr_null.time_svd + stats_spqr_null.stats_ssi.time_svd + stats_spqr_null.stats_ssp_N.time_svd
    if nargout == 4
